...
import { procedimentos, type Procedimento } from '../data';
import { X, CheckCircle2, MapPin, MessageCircle } from 'lucide-react';
...
export default function Procedimentos() {
  ...
  const listaFiltrada = categoriaAtiva
    ? procedimentos.filter((p) => (Array.isArray(p.categoria) ? p.categoria.includes(categoriaAtiva) : p.categoria === categoriaAtiva))
    : [];
