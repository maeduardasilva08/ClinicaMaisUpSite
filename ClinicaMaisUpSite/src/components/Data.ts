...
export interface AreaProcedimento {
  nome: string;
  exemplo: string;
  beneficios: string[];
}

export interface SubtipoProcedimento {
  nome: string;
  descricao: string;
}
...
export interface Procedimento {
  ...
  beneficios: string[];
  indicacoes: string[];
  subtipos?: SubtipoProcedimento[];
  areas?: AreaProcedimento[];
}
...
export const profissionais: Profissional[] = [
  {
    ...
    sobre:
      'Lilian Gabriel dedica sua carreira ao cuidado corporal, oferecendo tratamentos personalizados para promover saúde, bem-estar e autoestima. Seu atendimento é realizado de forma humanizada, buscando compreender as necessidades de cada paciente e proporcionar resultados seguros e eficazes.',
    especialidades: ['Tratamentos corporais', 'Pós-operatório de cirurgias', 'Protocolos personalizados', 'Estética corporal'],
    missao:
      'Acredito que cada paciente merece um atendimento individualizado, com carinho, dedicação e foco em alcançar os melhores resultados.',
    whatsapp: 'https://wa.me/5511985813441?text=Olá! Gostaria de agendar uma consulta com a Lilian Gabriel.',
    imagem: 'https://images.pexels.com/photos/3992854/pexels-photo-3992854.jpeg?auto=compress&cs=tinysrgb&w=600',
  },
  {
    id: 'larissa',
    nome: 'Larissa Cotrim',
    ...
    sobre:
      'Especialista em procedimentos faciais injetáveis e tratamentos corporais. Além dos atendimentos clínicos, atua como Responsável Técnica da Clínica Mais Up, garantindo segurança e excelência em todos os procedimentos.',
    especialidades: ['Harmonização Facial', 'Procedimentos Faciais Injetáveis', 'Tratamentos Corporais', 'Avaliação Estética'],
    missao:
      'Meu compromisso é unir conhecimento técnico, segurança e naturalidade para valorizar a beleza única de cada paciente.',
    whatsapp: 'https://wa.me/5511985813441?text=Olá! Gostaria de agendar uma consulta com a Larissa Cotrim.',
    imagem: 'https://images.pexels.com/photos/4173251/pexels-photo-4173251.jpeg?auto=compress&cs=tinysrgb&w=600',
  },
  {
    id: 'fabiola',
    nome: 'Fabiola Nizola',
    ...
    sobre:
      'Fabiola acredita que saúde e estética caminham juntas. Seu atendimento integra estética e nutrição para oferecer tratamentos completos e personalizados.',
    especialidades: ['Depilação a Laser', 'Avaliação Nutricional', 'Acompanhamento Nutricional', 'Estética Corporal'],
  ...
  },
  {
    ...
    sobre:
      'Janaína Camargo é apaixonada por valorizar a beleza natural de cada cliente. Atua com técnicas modernas, oferecendo um atendimento personalizado e cuidadoso.',
    especialidades: ['Design de Sobrancelhas', 'Micropigmentação de Sobrancelhas', 'Micropigmentação Labial', 'Extensão de Cílios', 'Embelezamento Facial'],
    ...
    imagem: 'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&cs=tinysrgb&w=600',
  },
];
...
export const procedimentos: Procedimento[] = [
  {
    ...
    categoria: 'Facial',
    descricao:
      'Técnica que adiciona fios sintéticos aos cílios naturais, proporcionando mais volume, curvatura e comprimento, com acabamento natural ou dramático.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Injeção de enzimas lipolíticas que aceleram a quebra de gordura localizada, melhoram a firmeza da pele e reduzem a aparência da celulite.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Aplicação de enzimas específicas na região submentoniana para reduzir o acúmulo de gordura e definir o contorno da mandíbula.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Escleroterapia para tratamento de pequenas veias superficiais visíveis no rosto, eliminando-as com segurança e sem cirurgia.',
  ...
  },
  {
    ...
    categoria: 'Nutrição',
    descricao:
      'Consulta com profissional de nutrição para análise do perfil alimentar, composição corporal e elaboração de plano nutricional individualizado.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Substância injetável que estimula a produção natural de colágeno, promovendo rejuvenescimento progressivo, melhora da firmeza e preenchimento de áreas flácidas.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Aplicação de toxina botulínica para relaxamento muscular controlado, suavizando rugas de expressão e prevenindo novas marcas.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Procedimento que alinha e fixa os fios das sobrancelhas em uma posição desejada, criando um efeito penteado, volumoso e uniforme.',
  ...
  },
  {
    ...
    descricao:
      'Infiltração de gás carbônico medicinal sob a pele para estimular a circulação e a oxigenação dos tecidos. Pode ser aplicada tanto no corpo quanto no rosto, com benefícios específicos para cada região.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Avaliação dermatológica especializada para diagnóstico e elaboração de protocolo personalizado no tratamento de manchas escuras na pele.',
  ...
  },
  {
    ...
    categoria: ['Corporal', 'Facial'],
    descricao:
      'Combinação de radiofrequência com resfriamento controlado que estimula a produção de colágeno e firma a pele. Pode ser aplicada tanto no corpo quanto no rosto, com benefícios específicos para cada região.',
  ...
  },
  {
    ...
    categoria: ['Corporal', 'Facial'],
    descricao:
      'Técnica que utiliza frio intenso e controlado para eliminar células de gordura localizada de forma não invasiva, sem tempo de recuperação. Pode ser aplicada tanto no corpo quanto no rosto, com benefícios específicos para cada região.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Tecnologia de luz pulsada que destrói o folículo piloso de forma definitiva e progressiva, reduzindo significativamente o crescimento dos pelos.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Remoção dos pelos pela raiz com cera quente ou fria, deixando a pele lisa por mais tempo em comparação ao barbear convencional.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Método ancestral de depilação com pasta de açúcar natural, indicada para peles sensíveis, com menor risco de irritação e pelos encravados.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Técnica minimamente invasiva que utiliza cânula para soltar aderências da pele, combatendo marcas de expressão profundas e cicatrizes.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Modelagem personalizada das sobrancelhas de acordo com o formato do rosto, com opção de coloração com henna para maior definição e durabilidade.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Protocolo de tratamento corporal que combina técnicas manuais e ativos cosméticos para eliminar toxinas, reduzir retenção hídrica e revitalizar o organismo.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Técnica de massagem que estimula o sistema linfático, elimina líquidos e toxinas acumulados no organismo e reduz o inchaço. A Clínica Mais Up oferece protocolos adaptados a diferentes necessidades.',
    ...
    subtipos: [
      {
        ...
        descricao:
          'Massagem suave e segura adaptada para gestantes, que estimula o sistema linfático, reduz inchaço e promove bem-estar durante a gravidez.',
      },
      {
        nome: 'Drenagem para Retenção',
        descricao:
          'Técnica de massagem que estimula o fluxo da linfa, eliminando líquidos e toxinas acumulados no organismo, reduzindo inchaço e sensação de peso.',
      },
    ],
  },
  {
    ...
    categoria: ['Corporal', 'Facial'],
    descricao:
      'Massagem mecânica com sucção controlada que estimula a circulação, a drenagem linfática e a produção de colágeno. Pode ser aplicada tanto no corpo quanto no rosto, com benefícios específicos para cada região.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Fios absorvíveis inseridos sob a pele para promover sustentação imediata e estimular o colágeno, resultando em lifting sem cirurgia.',
  ...
  },
  {
    ...
    descricao:
      'Terapia que utiliza luz de LED ou laser de baixa intensidade para estimular processos celulares, acelerando a reparação dos tecidos. Pode ser aplicada tanto no rosto quanto no corpo, com benefícios específicos para cada região.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Protocolo corporal com combinação de tecnologias e ativos para modelar, firmar e aumentar visualmente o volume dos glúteos.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Laser fracionado de alta precisão que promove renovação celular profunda, tratando rugas, manchas, cicatrizes e poros dilatados com eficácia.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Laser de picossegundos indicado para tratamento de manchas, melasma e rejuvenescimento, com mínimo desconforto e recuperação rápida.',
  ...
  },
  {
    ...
    categoria: ['Corporal', 'Facial'],
    descricao:
      'Terapia com luz LED ou laser de baixa intensidade que estimula a cicatrização, reduz inflamação e melhora a saúde da pele. Pode ser aplicada tanto no corpo quanto no rosto, com benefícios específicos para cada região.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Permanente para cílios naturais que os curva da raiz às pontas, criando efeito de olhar aberto e expressivo sem necessidade de máscara.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Procedimento que remove impurezas, cravos e células mortas da pele por meio de esfoliação, vapor e extração, deixando o rosto limpo e renovado.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'A Clínica Mais Up oferece diferentes tipos de massagem, unindo técnica e bem-estar para atender às necessidades de cada paciente.',
    ...
    subtipos: [
      {
        ...
        descricao:
          'Massagem vigorosa com movimentos específicos para quebrar nódulos de gordura, modelar o contorno corporal e melhorar a circulação.',
      },
      {
        nome: 'Massagem Relaxante',
        descricao:
          'Técnica de massagem com movimentos suaves e rítmicos para aliviar tensão muscular, reduzir o estresse e proporcionar bem-estar geral.',
      },
    ],
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Técnica com microagulhas que cria microlesões controladas na pele, estimulando a produção de colágeno e elastina para rejuvenescimento e tratamento de cicatrizes.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Técnica semipermanente de implantação de pigmento na derme para redesenhar, preencher ou definir as sobrancelhas com resultado natural.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Pigmentação semipermanente nos lábios para definir o contorno, uniformizar a cor e dar aparência de lábios mais cheios e corados.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Peeling suave de origem coreana que renova a camada superficial da pele, deixando-a mais luminosa, uniforme e com textura refinada.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Esfoliação mecânica com ponteira de diamante que remove células mortas e estimula a renovação celular, melhorando textura e viço da pele.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Aplicação de ácidos em concentrações controladas para promover esfoliação profunda, tratar manchas, acne e rugas, e renovar a pele.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Esfoliação por vibração ultrassônica que remove impurezas e células mortas sem contato abrasivo, indicada for peles sensíveis e reativas.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Equipamento que emite vibrações mecânicas para estimular a musculatura, melhorar a circulação, combater celulite e auxiliar na perda de medidas.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Protocolo de cuidados especializados após cirurgias plásticas, incluindo drenagem linfática, ultrassom e outros recursos para acelerar a recuperação.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Injeção de ácido hialurônico para restaurar volumes perdidos, suavizar sulcos e contornar lábios, maçãs do rosto e mandíbula.',
  ...
  },
  {
    ...
    categoria: ['Corporal', 'Facial'],
    descricao:
      'Tecnologia que emite ondas de calor nas camadas profundas da pele, estimulando colágeno e firmando os tecidos. Pode ser aplicada tanto no corpo quanto no rosto, com benefícios específicos para cada região.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Microinjeções de ácido hialurônico de baixa densidade que hidratam profundamente a pele, melhoram a luminosidade e reduzem linhas finas.',
  ...
  },
  {
    ...
    categoria: ['Corporal', 'Facial'],
    descricao:
      'Equipamento de ondas de choque que gera microestímulos mecânicos no tecido, promovendo remodelação do colágeno e melhora da circulação. Pode ser aplicado tanto no corpo quanto no rosto, com benefícios específicos para cada região.',
  ...
  },
  {
    ...
    categoria: ['Corporal', 'Facial'],
    descricao:
      'Equipamento que utiliza ondas sonoras de alta frequência para tratar gordura, celulite e flacidez, promovendo modelagem sem dor. Pode ser aplicado tanto no corpo quanto no rosto, com benefícios específicos para cada região.',
  ...
  },
  {
    ...
    categoria: 'Corporal',
    descricao:
      'Tecnologia que utiliza ondas ultrassônicas de baixa frequência para romper as células de gordura localizada, que são posteriormente eliminadas pelo organismo. É um procedimento exclusivamente corporal.',
  ...
  },
  {
    ...
    categoria: 'Facial',
    descricao:
      'Tecnologia de ultrassom focalizado que atinge camadas profundas da pele para promover lifting, firmeza e contorno facial sem cirurgia.',
